...
<xsl:stylesheet
    ...
    <xsl:template match="tei:TEI" mode="form">
        <xsl:result-document href="../../public/xpath/index.xhtml">
    ...
    <xsl:template match="tei:div[@type='slide'][not(@subtype)]">
        ...
        <xsl:result-document href="../../public/xpath/slide{$n}.xhtml" method="xhtml" doctype-public="'-//W3C//DTD XHTML 1.0 Strict//EN'" doctype-system="'http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd'">
    ...
    <xsl:template match="tei:div[@type='slide'][@subtype = 'xforms']">
        ...
        <xsl:result-document href="../../public/xpath/slide{$n}.xhtml">
            <xsl:processing-instruction name="xml-stylesheet" >href="../assets/xsltforms/xsltforms.xsl" type="text/xsl"</xsl:processing-instruction>
            <html
                xmlns="http://www.w3.org/1999/xhtml"
                xmlns:xf="http://www.w3.org/2002/xforms"
